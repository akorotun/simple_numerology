        ...
        <header class="py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                <div class="col-4">
                    ...
                    <a class="text-white-50 mr-2" href="/public/contacts/create">Контакти</a>
                </div>
                <div class="col-4 text-center">
                    <a class="blog-header-logo text-white" href="/public">Simple Numerology</a>
                </div>
                <div class="col-4 d-flex justify-content-end align-items-center">
                    ...
                    @guest
                        @if (Route::has('login'))
                                <a class="btn btn-sm btn-outline-info mr-1" href="{{ route('login') }}">{{ __('Авторизація') }}</a>
                        @endif

                        @if (Route::has('register'))
                                <a class="btn btn-sm btn-outline-info mr-1" href="{{ route('register') }}">{{ __('Реєстрація') }}</a>
                        @endif
                    @else
