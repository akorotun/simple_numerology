...
@section('content')
    ...
    <h3 class="mb-2 p-2">Нумерологічний онлайн калькулятор:</h3>
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            ...
            <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 h-md-250 position-relative shadow1">
                ...
                <div class="col p-4 d-flex flex-column position-static">
                    <h5 class="mb-3 p-0"><a href="/public/articles/5">Нумерологічний прогноз:</a></h5>

                    {!! Form::open(['action' => 'NumerologyCalculatorsController@forecast', 'method' => 'POST']) !!}
                    <div class="form-group mb-1">
                        {{ Form::label('day_b', 'День народження',
                            ['class'=>'col-lg-5 p-0']) }}
                        {{ Form::select('day_b', [
